...
<body>
    ...
    <x-app-layout></x-app-layout>
        ...
        <header>
            ...
            <!-- /TOP HEADER -->
            <div class="relative sm:justify-center sm:items-center bg-dots-darker bg-gray-100 selection:bg-red-500 selection:text-white">
